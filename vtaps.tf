...
resource "oci_core_capture_filter" "these" {
  for_each = var.vtap_configuration != null ? (var.vtap_configuration.capture_filter != null ? var.vtap_configuration.capture_filter : {}) : {}
  compartment_id = each.value.compartment_id != null ? each.value.compartment_id : (var.vtap_configuration.default_compartment_id != null ? var.vtap_configuration.default_compartment_id : null)
...
resource "oci_network_load_balancer_network_load_balancer" "these" {
  for_each = var.vtap_configuration != null ? (var.vtap_configuration.network_load_balancer != null ? var.vtap_configuration.network_load_balancer : {}) : {}
  compartment_id = each.value.compartment_id != null ? each.value.compartment_id : (var.vtap_configuration.default_compartment_id != null ? var.vtap_configuration.default_compartment_id : null)
  display_name   = each.value.display_name
...
resource "oci_core_vtap" "these" {
  for_each = var.vtap_configuration != null ? (var.vtap_configuration.vtap != null ? var.vtap_configuration.vtap : {}) : {}
...
resource "oci_network_load_balancer_listener" "these" {
  for_each = var.vtap_configuration != null ? (var.vtap_configuration.network_load_balancer_listener != null ? var.vtap_configuration.network_load_balancer_listener : {}) : {}
...
resource "oci_network_load_balancer_backend_set" "these" {
  for_each = var.vtap_configuration != null ? (var.vtap_configuration.network_load_balancer_backend_set != null ? var.vtap_configuration.network_load_balancer_backend_set : {}) : {}
  health_checker {
    protocol = each.value.protocol
  }
